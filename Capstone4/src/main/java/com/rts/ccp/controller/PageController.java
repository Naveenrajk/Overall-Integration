...
import com.rts.ccp.service.PagesService;
...
public class PageController {
	...
	@PostMapping("/page")
	public String performInsert(@RequestBody List<PagesDTO> pages) {
	...
	@PutMapping("/page")
	public String performUpdate(@RequestBody PagesDTO pages) {

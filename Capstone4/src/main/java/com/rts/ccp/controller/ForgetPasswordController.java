...
public class ForgetPasswordController {
	...
	public ResponseEntity<Response> updatePassword(@RequestBody Map<String, String> requestParams) {
		...
		if (!confirmPassword.equals(newPassword)){
			...
			if (passwordEncryption.encrypt(newPassword,loginId).equals (passwordDetails.getLastPassword1()) || passwordEncryption.encrypt(newPassword,loginId).equals (passwordDetails.getLastPassword2())
					|| passwordEncryption.encrypt(newPassword,loginId).equals(passwordDetails.getLastPassword3()) ){
				...
				passwordDetail.setLastPassword1(passwordEncryption.encrypt(newPassword,login.getLoginId()));
